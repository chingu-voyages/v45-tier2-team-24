    ...
    <div className="w-full mb-1">
      ...
      {isOpen === data.id && (
        <div className="w-full bg-gray-100 bg-slate-50 p-4 ">
          ...
          <p>
            <strong>Name Type:</strong> {data.nametype}
          </p>
          <p>
            <strong>Mass:</strong> {data.mass} g
          </p>
          <p>
            <strong>Fall:</strong> {data.fall}
          </p>
          <p>
            <strong>Date:</strong> {data.year?.slice(0, 10)}
          </p>
          <p>
            <strong>Latitude:</strong> {data.reclat}
          </p>
          <p>
            <strong>Longitude:</strong> {data.reclong}
          </p>
        </div>
      )}
    </div>
